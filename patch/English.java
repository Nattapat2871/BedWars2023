...
public class English extends Language {
    ...
    public English() {
        ...
        yml.addDefault("lobby-items-cosmetics-name", "&bCosmetics &7(Right-Click)");
        yml.addDefault("lobby-items-cosmetics-lore", List.of("&7Right-Click to open the cosmetics menu!"));
