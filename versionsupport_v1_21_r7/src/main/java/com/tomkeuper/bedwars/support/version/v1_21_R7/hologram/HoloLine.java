...
public class HoloLine implements IHoloLine {
    ...
    public HoloLine(String text, IHologram hologram) {
        ...
        final var positionMoveRotation = new PositionMoveRotation(entity.dI(), delta, 0, (float) entity.dR()); // trackingPosition(), , , getXRot()
        final Set<Relative> set = new HashSet<>();
        PacketPlayOutEntityTeleport teleportPacket = new PacketPlayOutEntityTeleport(entity.aA(), positionMoveRotation, set, false);
