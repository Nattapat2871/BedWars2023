            ...
            if (world.getName().equalsIgnoreCase(BedWars.getLobbyWorld())) {
                if (e.getEntity() instanceof Player) {
                    ...
                    if (e instanceof EntityDamageByEntityEvent) {
                        org.bukkit.entity.Entity damager = ((EntityDamageByEntityEvent) e).getDamager();
                        if (damager instanceof Player) {
                            if (!BreakPlace.isBuildSession((Player) damager)) {
                                e.setCancelled(true);
                            }
                        }
                    }
        ...
        if (e.getEntity() instanceof Player) {
            ...
            if (a != null) {
                ...
                if (e.getDamager() instanceof Player) {
                    ...
                    // Handle invisibility removal for mobs
                    if (a.getShowTime().containsKey(p)) {
                        // Always remove invisibility if hit by enemy mob
