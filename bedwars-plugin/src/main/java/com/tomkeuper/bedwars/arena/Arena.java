...
public class Arena implements IArena {
    ...
    public Arena(String name, @Nullable CommandSender p) {
        ...
        // Dynamic minPlayers based on config
        if (maxInTeam == 1) minPlayers = BedWars.config.getInt("min-players-per-mode.solo");
        else if (maxInTeam == 2) minPlayers = BedWars.config.getInt("min-players-per-mode.doubles");
        else if (maxInTeam == 3) minPlayers = BedWars.config.getInt("min-players-per-mode.3v3v3v3");
        else if (maxInTeam == 4) minPlayers = BedWars.config.getInt("min-players-per-mode.4v4v4v4");
